...
},{"./src/superagent-promise-plugin":163}],163:[function(require,module,exports){
/**
...
},{"./is-object":165,"./request":167,"./request-base":166,"emitter":1,"reduce":161}],165:[function(require,module,exports){
/**
...
},{"./is-object":165,"form-data":29}],167:[function(require,module,exports){
...
var CommentBox = React.createClass({
   ...
   loadCommentsFromServer: function loadCommentsFromServer() {
      ...
      req.use(superagentPromisePlugin).end().then(function (res) {
   ...
   handleCommentSubmit: function handleCommentSubmit(comment) {
      ...
      req.use(superagentPromisePlugin).send({ comment: comment }).end().then(function (res) {
...
ReactDOM.render(React.createElement(CommentBox, { url: '/api/comment', pollInterval: 2000 }), document.getElementById('container'));

},{"react":160,"react-dom":31,"superagent":164,"superagent-promise-plugin":162}]},{},[168]);
